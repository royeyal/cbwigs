  ...
  <a href="#" class="slide-link">
    <div class="slide-inner">
      ...
      <div class="slide-play-button">
        <svg class="slide-play-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
```css
background: color-mix(in srgb, #a39486 30%, transparent);
...
```css
.slide-play-button {
  background: color-mix(in srgb, #your-color 30%, transparent);
}
...
.slide-play-button {
  ...
  background: color-mix(in srgb, #a39486 60%, transparent);
}
```
